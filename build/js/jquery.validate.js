...
(function($) {
  $.extend($.fn, {
    ...
    ajaxResultShow: function(cl, message) {
      $(this).parent('.' + cl).not(':has(label.error)').append('<label class="error">' + message + '</label>');
      $(this).parent('.' + cl).has('label.error').find('label.error').css('display', 'inline');
    },
