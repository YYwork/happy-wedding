...
function submitOnline(){
  if ($(".J-find-btn").length>0){
    ...
    $("body").on("click",".J-error-btn",function(){
...
function cityPage(){
  $("body").on("click",".J-city-selbtn",function(){
    ...
    }).on("click",".J-city-errorbox",function(){
      $(this).hide();
    })
  var num=0
  $(".J-city-top").on("click",function(){
      num++;
      setTimeout(function(){
        if (num>0){
...
function selAlert(){
  ...
  $("body").on("click",".J-sel-alcon",function(e){
    if ($(e.target).hasClass("J-sel-alcon")){
      $(".J-sel-alcon").hide();
    }
  }).on("touchend",".J-sel-alcon",function(e){
    e.preventDefault();
  }).on("click",".J-sel-alcon input",function(){
    $(this).focus();
  })
...
function pagePub(){
  ...
  if ($(".J-top-select").length>0){
    ...
    $(".J-top-select").on("click",function(e){
    ...
    /*
    $(".J-pub-sellist li").on("click",function(e){
    ...
    */
    $(".J-pub-select li a").on("click",function(e){
       e.preventDefault();
    })
    $("body").on("click",".J-pub-selmask",function(){
...
function pinfo(){
  ...
  $(".J-big-con img").on("doubleClick ",function(){
    var html='<div class="m-pub-bigbox J-double-click" style="overflow:scroll">'+
      '<img src="'+$(this).attr("src")+'" style="-webkit-transform:scale(2,2)">'+
    '</div>';
    $("body").append(html);
  })
  $("body").on("click",".J-double-click",function(){
    $(this).remove();
  })
  tabImg({
  ...
  $(".J-pinfo-title").on("click",function(){
  ...
  /*
  $(".J-pinfo-top").on("click",function(){
    bigImage($(this));
  })
  $(".J-pinfo-demobox").on("click",function(){
    bigImage($(this));
  })
  $(".J-check-allImg").on("click",function(){
    bigImage($(this).parent().prev());
  })*/
  $(document).on("click",".J-pub-bigbox",function(e){
    setTimeout(function(){
...
function data(){
  if ($(".J-data-yearsel").length>0){
    ...
    bodyBox.on("click","span",function(){
      if (!$(this).hasClass("noclick")){
    ...
    $(".J-date-selbtn_2").on("click",function(){
      window.location="/Laohuangli/yijiehun"+'-'+year+'-'+month+'-'+day+'.html';

    })
    //弹窗(暂时不用了)
    $(".J-date-selbtn").on("click",function(){
    ...
    //关闭弹窗
    $(document).on("click", ".J-dateal-close",function() {
        $(this).parents(".J-date-alert").hide();
      }).on("click", ".J-date-submit",function() {
      ...
      }).on("click", ".J-error-btn",function() {
        $(this).parent().parent().parent().hide();
      }).on("click", ".J-right-box",function() {
        window.location = "/"
      })
...
function setMessage(){
  $(".J-set-message").on("click",function(){
  ...
  $("body").on("click",".J-inset-btn",function(){
  ...
  $("body").on("click",".J-set-box",function(e){
    if ($(e.target).hasClass("J-set-box")){
      $(".J-set-box").hide();
    }
  })
  $("body").on("click",".J-insert-phonerror",function(e){
...
function selectpage(){
  if ($(".J-sel-selbox").length>0){
    $(".J-sel-selbox div").on("click",function(){
      $(this).addClass("z-on").siblings().removeClass("z-on");
...
//热门城市
$(document).on("click",".J-city-hotbox",function(e){
